const Navbar = () => {
  return (
    <nav className="w-full">
      <div className="flex flex-wrap items-center justify-between mx-auto px-6 py-4 w-full">
        <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
          <h1 className="text-2xl font-bold">verver</h1>
        </a>
        <button data-collapse-toggle="navbar-hamburger" type="button" className="inline-flex items-center justify-center p-2 w-10 h-10 text-sm text-gray-500 rounded-lg" aria-controls="navbar-hamburger" aria-expanded="false">
